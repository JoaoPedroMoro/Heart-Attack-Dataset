...
I did an exploratory analysis of the data initially to avoid inconsistent or incorrect data. I then used machine learning algorithms to make this prediction. Each algorithm had a success rate and an error rate. Based on the success rates, I selected the algorithm with the best success rate. You can see the success rates of the algorithms in the image below.

![Success rate graphic for each algorithm] (graphic.png)
This graphic was obtained by Power BI, based on the "results.csv" file.
